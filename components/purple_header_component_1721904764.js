...
Vue.component("purple_header_component_1721904764", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Explore-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Explore.html" :class="[textStylePrimary, hoverTextStylePrimary]">Explore</a></li>
